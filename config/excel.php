...
return array(
    ...
    'properties' => [
        'creator'        => 'Adrián S. Arias',
        'lastModifiedBy' => 'Adrián S. Arias',
        'title'          => 'Pruebas de Hojas de Cálculo',
        'description'    => 'Exportación/Importación de Excel y Csv',
        'subject'        => 'Exportación/Importación de Excel y Csv',
        'keywords'       => 'maatwebsite, excel, export',
        'category'       => 'Excel',
        'manager'        => 'Dongato',
        'company'        => 'NewCharmeleon',
    ],
