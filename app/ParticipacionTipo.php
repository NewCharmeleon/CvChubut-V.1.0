...
class ParticipacionTipo extends Model
{
   ...
   //Accesor de atributo Nombre automatico cuando llamamos a $participaciones_tipos->nombre;
   ...
   //Accesor de atributo Descripcion automatico cuando llamamos a $participaciones_tipos->descripcion;
